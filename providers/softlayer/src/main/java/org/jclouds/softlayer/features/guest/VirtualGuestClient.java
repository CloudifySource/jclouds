...
public interface VirtualGuestClient {
   ...
   /**
    * Use this method to retrieve information about a guest's active transaction.
    *
    * @return The active transaction a server currently undertakes.
    * @see <a href=http://sldn.softlayer.com/reference/services/SoftLayer_Virtual_Guest/getActiveTransaction"/>
    */
    ...
    *
    * @return The last completed transaction a guest executed.
