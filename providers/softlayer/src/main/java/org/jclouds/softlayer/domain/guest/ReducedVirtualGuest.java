...
/>
 */
public class ReducedVirtualGuest extends SoftLayerNode {
   ...
   public Builder<?> toBuilder() {
      return new ConcreteBuilder().fromReducedVirtualGuest(this);
   }
   ...
   public abstract static class Builder<T extends Builder<T>> extends SoftLayerNode.Builder<T>  {
      ...
      protected boolean hourlyBillingFlag = true;
      
      // protected SupplementalCreateObjectOptions supplementalCreateObjectOptions;

      /**
       * @see ReducedVirtualGuest#getCreateDate()
       */
      ...
      /**
       * @see ReducedVirtualGuest#isDedicatedAccountHostOnly()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getLastVerifiedDate()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getMaxCpu()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getMaxCpuUnits()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getMaxMemory()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getMetricPollDate()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getModifyDate()
       */
      ...
      /**
       * see ReducedVirtualGuest#getBlockDevicesDiskCapacity()
       */
      ...
      /**
       * see ReducedVirtualGuest#getLocalDiskFlag()
       */
      ...
      /**
       * @see ReducedVirtualGuest#isPrivateNetworkOnlyFlag()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getMaxNetworkSpeed()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getOperatingSystemReferenceCode()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getStartCpus()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getStatusId()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getUuid()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getPostInstallScriptUri()
       */
      ...
      /**
       * @see ReducedVirtualGuest#getPrimaryBackendNetworkComponent()
       */
...
//      /**
//       * @see ReducedVirtualGuest#getSupplementalCreateObjectOptions()
//       */
...
//      }
      ...
      public ReducedVirtualGuest build() {
         return new ReducedVirtualGuest(accountId, createDate, dedicatedAccountHostOnly, domain, fullyQualifiedDomainName, hostname,
               ...
               datacenter, primaryBackendNetworkComponent
               );
      }

      public T fromReducedVirtualGuest(ReducedVirtualGuest in) {
         return this
...
//   }
   ...
   public int hashCode() {
      return Objects.hashCode(accountId, createDate, dedicatedAccountHostOnly, domain, fullyQualifiedDomainName,
              ...
              modifyDate, blockDevicesDiskCapacity, localDiskFlag, notes, privateNetworkOnlyFlag, startCpus, statusId, uuid, postInstallScriptUri, 
              primaryBackendIpAddress, primaryIpAddress, billingItemId, operatingSystem, datacenter, primaryBackendNetworkComponent/*,
   ...
   public boolean equals(Object obj) {
      ...
      ReducedVirtualGuest that = ReducedVirtualGuest.class.cast(obj);
