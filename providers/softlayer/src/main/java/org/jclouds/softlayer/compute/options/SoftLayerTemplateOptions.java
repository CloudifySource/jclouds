...
public class SoftLayerTemplateOptions extends TemplateOptions implements Cloneable {
    ...
    protected boolean powerOffBeforeCancel = false;
    ...
    public void copyTo(TemplateOptions to) {
        ...
        if (to instanceof SoftLayerTemplateOptions) {
            ...
            eTo.powerOffBeforeCancel(powerOffBeforeCancel);
    ...
    /**
     * will set the powerOffBeforeCancel flag when creating virtual guests.
     *
     * @see org.jclouds.softlayer.features.guest.VirtualGuestClient#createVirtualGuest
     */
    public TemplateOptions powerOffBeforeCancel(boolean powerOffBeforeCancel) {
        this.powerOffBeforeCancel = powerOffBeforeCancel;
        return this;
    }
    ...
    public boolean isPowerOffBeforeCancel() {
        return powerOffBeforeCancel;
    }
    ...
    public static class Builder {
        ...
        /**
         * @see #powerOffBeforeCancel
         */
        public static SoftLayerTemplateOptions powerOffBeforeCancel(boolean powerOffBeforeCancel) {
            SoftLayerTemplateOptions options = new SoftLayerTemplateOptions();
            return SoftLayerTemplateOptions.class.cast(options.powerOffBeforeCancel(powerOffBeforeCancel));
        }
