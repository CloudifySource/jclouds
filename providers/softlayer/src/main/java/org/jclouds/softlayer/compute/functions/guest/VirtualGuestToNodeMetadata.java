 ...
 */
@Singleton
public class VirtualGuestToNodeMetadata implements Function<SoftLayerNode, NodeMetadata> {
   ...
   public NodeMetadata apply(SoftLayerNode from) {
      ...
      Image image = images.getImage((VirtualGuest) from);
      if (image != null) {
         builder.imageId(image.getId());
         builder.operatingSystem(image.getOperatingSystem());
         builder.hardware(hardware.getHardware((VirtualGuest) from));
      }
