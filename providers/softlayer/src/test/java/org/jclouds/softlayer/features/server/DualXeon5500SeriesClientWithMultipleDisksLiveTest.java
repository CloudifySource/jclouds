...
public class DualXeon5500SeriesClientWithMultipleDisksLiveTest extends HardwareServerClientLiveTest {
	   ...
	   protected Properties setupProperties() {
	      ...
	      properties.setProperty(PROPERTY_SOFTLAYER_EXTERNAL_DISKS_IDS, "14,471,471,471");
	   ...
	   public void testVerifyOrderDedicated() {
	      ...
	      templateBuilder.locationId("37473").hardwareId("1111,828,14,1284,249").imageId("4321");
