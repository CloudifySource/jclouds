...
public class DualXeon5500SeriesClientLiveTest extends HardwareServerClientLiveTest {
	   ...
	   public void testVerifyOrderDedicated() {
	      ...
	      int pkgId = Iterables.find(api.getAccountClient().getReducedActivePackages(),
	              named(ProductPackageClientLiveTest.DUAL_XEON_5500_DEDICATED_SERVER_PACKAGE_NAME)).getId();
	      ...
	      templateBuilder.locationId("37473").hardwareId("1111,826,14,186,30");
