 ...
 */
package org.jclouds.softlayer.compute.guest;
...
public class SoftLayerVirtualGuestComputeServiceAdapterLiveTest extends BaseSoftLayerClientLiveTest {

   private SoftLayerComputeServiceAdapter adapter;
   private TemplateBuilder templateBuilder;
   private Factory sshFactory;
   private NodeAndInitialCredentials<SoftLayerNode> guest;
   ...
   protected void doConnectViaSsh(SoftLayerNode guest, LoginCredentials creds) {
   ...
   public void testListHardwareProfiles() {
      ...
      for (Iterable<ProductItem> profile : profiles) {
         // CPU, RAM ,Volume and Uplink
         assertEquals(Iterables.size(profile), 4);
      }
   }
   ...
   protected Properties setupProperties() {
      ...
      // no need to add virtual guest properties since it is the default.
