...
public class AccountAsyncClientTest extends BaseSoftLayerAsyncClientTest<AccountAsyncClient> {
   ...
   public void testGetBillingOrder() {

      Invokable<?, ?> method = method(AccountAsyncClient.class, "getBillingOrder", int.class);
      GeneratedHttpRequest httpRequest = processor.createRequest(method, ImmutableList.<Object> of(1234));

      assertRequestLineEquals(
              httpRequest,
              "GET https://api.softlayer.com/rest/v3/SoftLayer_Billing_Order/1234 HTTP/1.1");
      assertNonPayloadHeadersEqual(httpRequest, "Accept: application/json\n");
      assertPayloadEquals(httpRequest, null, null, false);
   ...
   public void testGetReducedActivePackage() {
      Invokable<?, ?> method = method(AccountAsyncClient.class, "getReducedActivePackages");
      GeneratedHttpRequest httpRequest = processor.createRequest(method, ImmutableList.of());

      assertRequestLineEquals(
              httpRequest,
              "GET https://api.softlayer.com/rest/v3/SoftLayer_Account/ActivePackages.json?objectMask=id%3Bname HTTP/1.1");
      assertNonPayloadHeadersEqual(httpRequest, "Accept: application/json\n");
      assertPayloadEquals(httpRequest, null, null, false);
