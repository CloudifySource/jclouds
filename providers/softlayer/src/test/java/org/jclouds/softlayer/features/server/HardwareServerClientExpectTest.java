...
public class HardwareServerClientExpectTest extends BaseRestClientExpectTest<SoftLayerClient> {
   ...
   public void testCancelServerReturnsTrueOn200AndFalseOn404() {
      ...
      SoftLayerClient clientWhenServiceExists = requestSendsResponse(cancelServer11, found);
      ...
      SoftLayerClient clientWhenServiceDoesntExist = requestSendsResponse(cancelServer11, notFound);
