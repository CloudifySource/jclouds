 ...
 */
package org.jclouds.softlayer.compute.functions.datacenter;
...
public class DatacenterToLocationTest {
   ...
   public static DatacenterToLocation function = new DatacenterToLocation(new JustProvider("softlayer", Suppliers
